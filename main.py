...
def bugtool():
    ...
    variables = {"first": 50, "last": 50, "jql": 'project = SOUL AND type = Bug AND "Epic Link" = SOUL-38 ORDER BY created DESC', "amountOfIds": 1000, "isMaxResultsLimitEnabled": True}
    ...
    send = requests.post('https://open.feishu.cn/open-apis/bot/v2/hook/1fd5b813-e5ba-4d74-90ba-4eeaa3f8aeaa',json.dumps(p))
