...
def bugtool():
    ...
    variables = {"first": 50, "last": 50, "jql": 'project = NLP AND type = Bug AND "Epic Link" = NLP-34 ORDER BY created DESC', "amountOfIds": 1000, "isMaxResultsLimitEnabled": True}
    ...
    send = requests.post('https://open.feishu.cn/open-apis/bot/v2/hook/fe34cd89-5afa-4ece-bb24-745b807538f5',json.dumps(p))
