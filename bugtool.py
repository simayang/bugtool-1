...
def bugtool():
    ...
    variables = {"first": 50, "last": 50, "jql": 'project = DX AND type = Bug ORDER BY created DESC', "amountOfIds": 1000, "isMaxResultsLimitEnabled": True}
    ...
    send = requests.post('https://open.feishu.cn/open-apis/bot/v2/hook/b15c1367-b8be-4b5b-b405-49697dd60991',json.dumps(p))
